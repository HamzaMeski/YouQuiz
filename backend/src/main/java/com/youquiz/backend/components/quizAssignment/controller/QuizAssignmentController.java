...
import com.youquiz.backend.components.quizAssignment.service.QuizAssingmentService;
...
public class QuizAssignmentController extends Controller<QuizAssignment, Long, CreateAssignmenentDTO, UpdateAssignmenentDTO, AssignmentResponseDTO> {
   private final QuizAssingmentService quizAssingmentService;

    public QuizAssignmentController(QuizAssingmentService quizAssingmentService) {
